package svenhjol.strange.feature.enchantable_horse_armor;
...
@Feature(mod = Strange.MOD_ID, description = "Horse armor can be enchanted.")
public class EnchantableHorseArmor extends CharmFeature implements IHorseArmorEnchantmentProvider {
    ...
    private void addEnchantment(Enchantment enchantment) {
        if (!ENCHANTMENTS.contains(enchantment)) {
            Strange.instance().log().debug(getClass(), "Adding enchantment " + enchantment);
