...
public class DecorationHelper
{
    ...
    public static class StructureBlockReplacement
    {
        ...
        protected void bookshelf()
        {
            ...
            if (Charm.hasModule(BookshelfChests.class) && rand.nextFloat() < getChance(this.data, 0.22F)) {
        ...
        protected void chest()
        {
            ...
            ResourceLocation defaultLoot = tables.get(rand.nextInt(tables.size()));
        ...
        protected void rune()
        {
            if (!Strange.loader.hasModule(Runestones.class) || rand.nextFloat() > getChance(this.data, 0.75F)) return;
        ...
        {
            if (rand.nextFloat() > getChance(this.data, 0.7F)) return;
        ...
        public ResourceLocation getLootTable(String data, ResourceLocation def)
        {
