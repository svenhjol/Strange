...
{
    public EncounterGenerator(World world, IQuest quest, Generator.Definition definition)
    {
    ...
    public void generate()
    {
        ...
        for (String targetStr : def.keySet()) {
            ...
            int count = data.containsKey("count") ? definition.parseCount(data.get("count")) : 0;
