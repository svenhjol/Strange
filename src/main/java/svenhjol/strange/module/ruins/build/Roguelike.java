...
public class Roguelike extends CharmStructure {
    ...
    public Roguelike() {
        ...
        ROOMS.put("level4_room_cells2", 5);
        ...
        ENDS.put("level4_end_creepers", 2);
        ENDS.put("level4_end_plain", 5);
        ENDS.put("level4_end_water1", 4);
