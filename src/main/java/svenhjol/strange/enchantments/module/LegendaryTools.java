...
public class LegendaryTools extends MesonModule implements ILegendaryItem {
    ...
    public ItemStack getItemStack() {
        ...
        Tag<Item> legendaryItemsTag = ItemTags.getCollection().get(new ResourceLocation("strange:legendary_tools"));

        //If the tag is missing for some reasons use a default list
