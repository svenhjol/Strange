...
public class SurfaceRuinGenerator extends BaseGenerator {
    ...
    public static void init() {
        BADLANDS_POOL = registerPool(new Identifier(Strange.MOD_ID, "ruins/surface/badlands/starts"), BADLANDS_RUINS);
        DESERT_POOL = registerPool(new Identifier(Strange.MOD_ID, "ruins/surface/desert/starts"), DESERT_RUINS);
        FOREST_POOL = registerPool(new Identifier(Strange.MOD_ID, "ruins/surface/forest/starts"), FOREST_RUINS);
        JUNGLE_POOL = registerPool(new Identifier(Strange.MOD_ID, "ruins/surface/jungle/starts"), JUNGLE_RUINS);
        MOUNTAINS_POOL = registerPool(new Identifier(Strange.MOD_ID, "ruins/surface/mountains/starts"), MOUNTAINS_RUINS);
        PLAINS_POOL = registerPool(new Identifier(Strange.MOD_ID, "ruins/surface/plains/starts"), PLAINS_RUINS);
        SAVANNA_POOL = registerPool(new Identifier(Strange.MOD_ID, "ruins/surface/savanna/starts"), SAVANNA_RUINS);
        SNOWY_POOL = registerPool(new Identifier(Strange.MOD_ID, "ruins/surface/snowy/starts"), SNOWY_RUINS);
        TAIGA_POOL = registerPool(new Identifier(Strange.MOD_ID, "ruins/surface/taiga/starts"), TAIGA_RUINS);
    }
}
