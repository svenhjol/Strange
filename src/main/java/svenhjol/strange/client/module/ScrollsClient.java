...
import svenhjol.strange.client.toast.QuestToast;
import svenhjol.strange.client.toast.QuestToastType;
import svenhjol.strange.item.ScrollItem;
import svenhjol.strange.client.gui.screen.ScrollScreen;
import svenhjol.strange.scroll.tag.Quest;
import svenhjol.strange.client.gui.screen.TravelJournalScrollsScreen;

import java.util.ArrayList;
import java.util.List;
import java.util.Random;

import static svenhjol.strange.module.Scrolls.*;
